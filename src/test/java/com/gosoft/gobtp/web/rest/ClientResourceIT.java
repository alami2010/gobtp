...
import static com.gosoft.gobtp.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    private static final Boolean DEFAULT_IS_PROFESSIONAL = false;
    private static final Boolean UPDATED_IS_PROFESSIONAL = true;
    ...
    public static Client createEntity() {
        Client client = new Client()
            .name(DEFAULT_NAME)
            .isProfessional(DEFAULT_IS_PROFESSIONAL)
            .date(DEFAULT_DATE)
    ...
    public static Client createUpdatedEntity() {
        Client updatedClient = new Client()
            .name(UPDATED_NAME)
            .isProfessional(UPDATED_IS_PROFESSIONAL)
            .date(UPDATED_DATE)
        ...
        User user = UserResourceIT.createEntity();
        user.setId("fixed-id-for-tests");
        updatedClient.setInternalUser(user);
    ...
    @Test
    void checkIsProfessionalIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        client.setIsProfessional(null);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].isProfessional").value(hasItem(DEFAULT_IS_PROFESSIONAL.booleanValue())))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.isProfessional").value(DEFAULT_IS_PROFESSIONAL.booleanValue()))
