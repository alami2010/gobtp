...
import reducer, {
  ...
  reset,
  updateEntity,
} from './travail-supplementaire.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAVAILSUPPLEMENTAIRE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAVAILSUPPLEMENTAIRE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAVAILSUPPLEMENTAIRE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_TRAVAILSUPPLEMENTAIRE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_TRAVAILSUPPLEMENTAIRE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TRAVAILSUPPLEMENTAIRE actions', async () => {
      const arg = 42666;
