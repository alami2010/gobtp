...
import reducer, {
  ...
  reset,
  updateEntity,
} from './materiau-manquant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIAUMANQUANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIAUMANQUANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIAUMANQUANT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_MATERIAUMANQUANT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIAUMANQUANT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MATERIAUMANQUANT actions', async () => {
      const arg = 42666;
