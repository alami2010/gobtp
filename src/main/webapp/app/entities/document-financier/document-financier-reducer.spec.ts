...
import reducer, {
  ...
  reset,
  updateEntity,
} from './document-financier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTFINANCIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTFINANCIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTFINANCIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_DOCUMENTFINANCIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTFINANCIER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DOCUMENTFINANCIER actions', async () => {
      const arg = 42666;
