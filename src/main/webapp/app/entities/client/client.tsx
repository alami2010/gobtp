          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isProfessional')}>
                  Is Professional <FontAwesomeIcon icon={getSortIconByFieldName('isProfessional')} />
                </th>
            ...
            <tbody>
              {clientList.map((client, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{client.name}</td>
                  <td>{client.isProfessional ? 'true' : 'false'}</td>
                  <td>{client.date ? <TextFormat type="date" value={client.date} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{client.adresse}</td>
                  <td>{client.info}</td>
                  <td>{client.internalUser ? client.internalUser.login : ''}</td>
