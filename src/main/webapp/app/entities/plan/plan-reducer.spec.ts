...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLAN actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_PLAN actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_PLAN actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PLAN actions', async () => {
      const arg = 42666;
