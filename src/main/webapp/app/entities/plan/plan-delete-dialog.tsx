...
import { deleteEntity, getEntity } from './plan.reducer';
...
export const PlanDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/plan${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gobtpApp.plan.delete.question">Êtes-vous certain de vouloir supprimer le Plan {planEntity.id} ?</ModalBody>
      <ModalFooter>
