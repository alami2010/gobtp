...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './chantier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANTIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHANTIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHANTIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CHANTIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CHANTIER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CHANTIER actions', async () => {
      const arg = 42666;
