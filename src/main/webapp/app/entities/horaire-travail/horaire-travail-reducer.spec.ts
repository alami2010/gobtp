...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HORAIRETRAVAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HORAIRETRAVAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HORAIRETRAVAIL actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_HORAIRETRAVAIL actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_HORAIRETRAVAIL actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_HORAIRETRAVAIL actions', async () => {
      const arg = 42666;
