...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHOTOTRAVAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHOTOTRAVAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHOTOTRAVAIL actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_PHOTOTRAVAIL actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_PHOTOTRAVAIL actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PHOTOTRAVAIL actions', async () => {
      const arg = 42666;
