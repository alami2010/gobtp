...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './materiau.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIAU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIAU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIAU actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_MATERIAU actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIAU actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MATERIAU actions', async () => {
      const arg = 42666;
