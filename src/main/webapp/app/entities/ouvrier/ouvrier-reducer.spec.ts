...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './ouvrier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUVRIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OUVRIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OUVRIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_OUVRIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_OUVRIER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_OUVRIER actions', async () => {
      const arg = 42666;
