...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './travail.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAVAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAVAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAVAIL actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_TRAVAIL actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_TRAVAIL actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TRAVAIL actions', async () => {
      const arg = 42666;
