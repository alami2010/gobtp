...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHEFCHANTIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHEFCHANTIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHEFCHANTIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CHEFCHANTIER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CHEFCHANTIER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CHEFCHANTIER actions', async () => {
      const arg = 42666;
